...
To enable maintenance mode, in the admin at *Preferences*  / *Site*, set *Maintenance mode active?* option to *Yes*. Unauthenticated visitors will now see an 503 error page.

To change what is displayed on the error page, create or update your `error_503` page template.
